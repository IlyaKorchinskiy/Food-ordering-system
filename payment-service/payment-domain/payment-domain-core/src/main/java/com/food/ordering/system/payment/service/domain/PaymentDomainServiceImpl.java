...
public class PaymentDomainServiceImpl implements PaymentDomainService {
    ...
    private void validateCreditHistory(
        ...
        Money creditHistoryAmount = getTotalHistoryAmount(creditHistories, TransactionType.CREDIT);
        Money debitHistoryAmount = getTotalHistoryAmount(creditHistories, TransactionType.DEBIT);

        if (debitHistoryAmount.isGreaterThan(creditHistoryAmount)) {
            log.error(
        ...
        if (!creditEntry.getTotalCreditAmount().equals(creditHistoryAmount.substract(debitHistoryAmount))) {
            log.error(
