...
import com.food.ordering.system.payment.service.dataaccess.exception.OrderOutboxNotFoundException;
import com.food.ordering.system.payment.service.dataaccess.mapper.OrderOutboxDataAccessMapper;
import com.food.ordering.system.payment.service.dataaccess.repository.OrderOutboxJpaRepository;
...
public class OrderOutboxRepositoryImpl implements OrderOutboxRepository {
    ...
    public Optional<List<OrderOutboxMessage>> findByTypeAndOutboxStatus(String type, OutboxStatus outboxStatus) {
        List<OrderOutboxMessage> orderOutboxMessages = orderOutboxJpaRepository
                ...
                .orElseThrow(() ->
                        new OrderOutboxNotFoundException("Order outbox object cannot be found for saga type " + type))
                .stream()
